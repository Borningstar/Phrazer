...
namespace Phrazer
{
	...
	{
		public static Dictionary<string, Dictionary<string, List<string>>> WhoWins(){
		...
		public static Dictionary<string, Dictionary<string, List<string>>> ExplainToMe(){
			...
			Dictionary<string, Dictionary<string, List<string>>> explainToMe = new Dictionary<string, Dictionary<string, List<string>>>
			{
				{ "start", new Dictionary<string, List<string>> { 
